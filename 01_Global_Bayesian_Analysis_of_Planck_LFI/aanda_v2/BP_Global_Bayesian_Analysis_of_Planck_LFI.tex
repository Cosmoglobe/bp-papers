...
\begin{figure*}{t}
  ...
  \caption{Posterior summary maps for the LFI 30\,GHz channel. Columns
    ...
    polarization maps in the two rows have been smoothed to an
...
\begin{table*}[t]       %  Table 1
  ...
  \caption{Summary of cosmological parameters dominated by large-scale
    ...
    terms of probability-to-exceed; and 7) primary reference. See \citet{bp12} for further discussion.
  ...
  \Planck\ 2018 & \omit \lfi\hfil& 0.50&  0.064\pm0.019& \le1.7 & & \omit\citet{planck2016-l05}\hfil\cr
  ...
  \BP, $\ell=2$--8, no $TE$& \omit LFI, \WMAP\ \emph{Ka}--\emph V\hfil& 0.68&  0.058\pm{0.012}& <1.3& 0.32& \textrm{\citet{bp12}}\cr 
