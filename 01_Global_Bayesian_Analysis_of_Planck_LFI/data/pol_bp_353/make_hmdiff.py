...
for filename, outfile, coltype, vmin, vmax, dataset, freq, unit, scale, comp, labelpos, labels, bar in [
    (directory+"bp_030_hmdiff_v001_2deg.fits", "bp_030_hmdiff_2deg_T.pdf", 0, -10., 10., r"", r"$T_{\mathrm{30}}$", r"$\mathrm{\mu K}$", 1, 0, [-10,0,10], [r"$-10$", r"0", r"$10$"], 0),
    (directory+"bp_030_hmdiff_v001_2deg.fits", "bp_030_hmdiff_2deg_Q.pdf", 0, -10., 10., r"", r"$Q_{\mathrm{30}}$", r"$\mathrm{\mu K}$", 1, 1, [-10,0,10], [r"$-10$", r"0", r"$10$"], 0),
    (directory+"bp_030_hmdiff_v001_2deg.fits", "bp_030_hmdiff_2deg_U.pdf", 0, -10., 10., r"", r"$U_{\mathrm{30}}$", r"$\mathrm{\mu K}$", 1, 2, [-10,0,10], [r"$-10$", r"0", r"$10$"], 0),
    (directory+"bp_044_hmdiff_v001_2deg.fits", "bp_044_hmdiff_2deg_T.pdf", 0, -10., 10., r"", r"$T_{\mathrm{44}}$", r"$\mathrm{\mu K}$", 1, 0, [-10,0,10], [r"$-10$", r"0", r"$10$"], 0),
    (directory+"bp_044_hmdiff_v001_2deg.fits", "bp_044_hmdiff_2deg_Q.pdf", 0, -10., 10., r"", r"$Q_{\mathrm{44}}$", r"$\mathrm{\mu K}$", 1, 1, [-10,0,10], [r"$-10$", r"0", r"$10$"], 0),
    (directory+"bp_044_hmdiff_v001_2deg.fits", "bp_044_hmdiff_2deg_U.pdf", 0, -10., 10., r"", r"$U_{\mathrm{44}}$", r"$\mathrm{\mu K}$", 1, 2, [-10,0,10], [r"$-10$", r"0", r"$10$"], 0),
    (directory+"bp_070_hmdiff_v001_2deg.fits", "bp_070_hmdiff_2deg_T.pdf", 0, -10., 10., r"", r"$T_{\mathrm{70}}$", r"$\mathrm{\mu K}$", 1, 0, [-10,0,10], [r"$-10$", r"0", r"$10$"], 0),
    (directory+"bp_070_hmdiff_v001_2deg.fits", "bp_070_hmdiff_2deg_Q.pdf", 0, -10., 10., r"", r"$Q_{\mathrm{70}}$", r"$\mathrm{\mu K}$", 1, 1, [-10,0,10], [r"$-10$", r"0", r"$10$"], 0),
    (directory+"bp_070_hmdiff_v001_2deg.fits", "bp_070_hmdiff_2deg_U.pdf", 0, -10., 10., r"", r"$U_{\mathrm{70}}$", r"$\mathrm{\mu K}$", 1, 2, [-10,0,10], [r"$-10$", r"0", r"$10$"], 0),
]:
