...
for filename1, filename2, outfile, coltype, vmin, vmax, dataset, freq, unit, scale, comp, labelpos, labels, bar in [
    #("map_030_n1024_R3.00_bpc_hm1_5deg_n64.fits", "map_030_n1024_R3.00_bpc_hm2_5deg_n64.fits", "dpc2018_hmdiff_030_5deg_T.pdf", 0, -3., 3., r"", r"$T_{\mathrm{30}}$", r"$\mathrm{\mu K}$", 1, 0, [-3,0,3], [r"$-3$", r"0", r"$3$"], 0),
    #("map_030_n1024_R3.00_bpc_hm1_5deg_n64.fits", "map_030_n1024_R3.00_bpc_hm2_5deg_n64.fits", "dpc2018_hmdiff_030_5deg_Q.pdf", 0, -3., 3., r"", r"$Q_{\mathrm{30}}$", r"$\mathrm{\mu K}$", 1, 1, [-3,0,3], [r"$-3$", r"0", r"$3$"], 0),
    #("map_030_n1024_R3.00_bpc_hm1_5deg_n64.fits", "map_030_n1024_R3.00_bpc_hm2_5deg_n64.fits", "dpc2018_hmdiff_030_5deg_U.pdf", 0, -3., 3., r"", r"$Q_{\mathrm{30}}$", r"$\mathrm{\mu K}$", 1, 2, [-3,0,3], [r"$-3$", r"0", r"$3$"], 0),
    #("npipe6v20A_030_map_uK_5deg_n64.fits", "npipe6v20B_030_map_uK_5deg_n64.fits", "npipe_ABdiff_030_5deg_T.pdf", 0, -3., 3., r"", r"$T_{\mathrm{30}}$", r"$\mathrm{\mu K}$", 1, 0, [-3,0,3], [r"$-3$", r"0", r"$3$"], 0),
    #("npipe6v20A_030_map_uK_5deg_n64.fits", "npipe6v20B_030_map_uK_5deg_n64.fits", "npipe_ABdiff_030_5deg_Q.pdf", 0, -3., 3., r"", r"$Q_{\mathrm{30}}$", r"$\mathrm{\mu K}$", 1, 1, [-3,0,3], [r"$-3$", r"0", r"$3$"], 0),
    #("npipe6v20A_030_map_uK_5deg_n64.fits", "npipe6v20B_030_map_uK_5deg_n64.fits", "npipe_ABdiff_030_5deg_U.pdf", 0, -3., 3., r"", r"$Q_{\mathrm{30}}$", r"$\mathrm{\mu K}$", 1, 2, [-3,0,3], [r"$-3$", r"0", r"$3$"], 0),
    #("bp_030_map_full_n0512_v0.01_1deg.fits", "bp_044_map_full_n0512_v0.01_1deg.fits", "bp_30minus44_1deg_U.pdf", 0, -10., 10., r"", r"$U$", r"$\mathrm{\mu K}$", 1, 2, [-10,0,10], [r"$-10$", r"0", r"$10$"], 0),
    ("bp_030_map_full_n0512_v0.01_1deg.fits", "bp_044_map_full_n0512_v0.01_1deg.fits", "bp_30minus44_1deg_Q.pdf", 0, -10., 10., r"", r"$Q$", r"$\mathrm{\mu K}$", 1, 1, [-10,0,10], [r"$-10$", r"0", r"$10$"], 0),
]:
    
    m1 = hp.ma(hp.read_map(filename1,comp))*scale
    m2 = hp.ma(hp.read_map(filename2,comp))*scale
    m  = (0.35*m1-m2)
    if coltype == 2:
        ind = N.where(m > 0)
