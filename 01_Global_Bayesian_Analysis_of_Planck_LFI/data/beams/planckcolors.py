...
def load_colormap(filename):
    ...
    """
    try:
        colormap = ListedColormap(np.loadtxt(os.path.join(".", filename))/255.)
    except IOError:
...
colombi1_cmap = load_colormap("parchment1.dat")

############### Universal colormap
# setup linear colormap
from matplotlib.colors import ListedColormap
planck_freqmap_cmap = load_colormap("parchment1.dat")
