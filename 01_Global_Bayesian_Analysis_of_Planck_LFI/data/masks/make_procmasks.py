...
for filename, outfile, coltype, vmin, vmax, dataset, freq, unit, scale, comp, labelpos, labels, bar in [
    #(directory+"mask_proc_sum.fits", "mask_proc_sum.pdf", 0, 0., 2., r"", r"", r"", 1, 0, [0,0,3400], [r"$-3400$", r"0", r"$3400$"], 0),
    (directory+"mask_bp8_full_I_n1024_v6.0_LFIPntSrc.fits", "mask_BP8_T_v2.pdf", 0, 0., 1., r"", r"", r"", 1, 0, [0,0,3400], [r"$-3400$", r"0", r"$3400$"], 0),        
    #(directory+"mask_wmap_dx12_n8_QU_comb.fits", "mask_BP8_P_v1.pdf", 0, 0., 2., r"", r"", r"", 1, 1, [0,0,3400], [r"$-3400$", r"0", r"$3400$"], 0),
    #(directory+"mask_proc_tot_res_v5_n1024.fits", "mask_proc_BP8_v1.pdf", 0, 0., 14., r"", r"", r"", 1, 1, [0,0,3400], [r"$-3400$", r"0", r"$3400$"], 0),
    #(directory+"mask_proc_tot_smap6_res_v5_n1024.fits", "mask_proc_smap6_BP8_v1.pdf", 0, 0., 25., r"", r"", r"", 1, 1, [0,0,3400], [r"$-3400$", r"0", r"$3400$"], 0),        
]:
