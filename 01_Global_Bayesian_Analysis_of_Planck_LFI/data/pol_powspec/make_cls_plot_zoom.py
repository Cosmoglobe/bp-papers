...
#bp30_v3 = np.loadtxt('cls_bp_030_map_full_n0512_v0.03.dat')
...
plt.plot(npipe30[0:1499,0], npipe30[0:1499,1], label='NPIPE', linewidth=1, color='red',   alpha=0.3)
plt.plot(bp30[0:1499,0],    bp30[0:1499,1],    label='BP',    linewidth=1, color='black', alpha=1)
#plt.plot(bp30_v3[0:1499,0],    bp30[0:1499,1],    label='BP (fixed flags)',    linewidth=1, color='gray', alpha=1)
...
# legend
leg = plt.legend(frameon=True, loc=1, fontsize=10)
...
#ax1.set_xscale("log")
#ax1.set_yscale("log")
plt.ylim([0.0023, 0.015]); plt.xlim([200, 1400]);

#plt.xticks([0.01,0,010,100,1000,10000,100000], [r"$10^1$", r"$10^2$", r"$10^3$", r"$10^4$", r"$10^5$"])
plt.yticks([0.004,0.008,0.012], [r"$0.004$", r"$0.008$", r"$0.012$"])
plt.setp( ax1.get_xticklabels(), visible=False)

# reduce white space around figure
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)

plt.text(250,0.0027,r"$TT$, 30 GHz", fontsize=12)
...
#ax2.set_yscale("log")
plt.ylim([0.0023, 0.015]); plt.xlim([200, 1400]);
#plt.ylim([2e-3, 200]); plt.xlim([1.2, 1400]);
...
plt.text(250,0.0027,r"$EE$, 30 GHz", fontsize=12)
...
plt.text(250,0.0027,r"$BB$, 30 GHz", fontsize=12)
...
#ax4.set_yscale("log")
plt.ylim([0.0023, 0.015]); plt.xlim([200, 1400]);
#plt.ylim([2e-3, 10000]); plt.xlim([1.2, 1400]);
...
plt.text(250,0.0027,r"$TT$, 44 GHz", fontsize=12)
...
plt.text(250,0.0027,r"$EE$, 44 GHz", fontsize=12)
...
plt.text(250,0.0027,r"$BB$, 44 GHz", fontsize=12)
...
#ax7.set_xscale("log")
#ax7.set_yscale("log")
plt.ylim([0.0023, 0.015]); plt.xlim([200, 2500]);
#plt.ylim([2e-3, 10000]); plt.xlim([1.2, 2500]);
...
plt.text(250,0.0027,r"$TT$, 70 GHz", fontsize=12)
...
plt.text(250,0.0027,r"$EE$, 70 GHz", fontsize=12)
...
#ax9.set_yscale("log")
plt.ylim([0.0023, 0.015]); plt.xlim([200, 2500]);
#plt.ylim([2e-3, 200]); plt.xlim([1.2, 2500]);
...
plt.text(250,0.0027,r"$BB$, 70 GHz", fontsize=12)
...
plt.savefig("cls_bp_npipe_dpc_zoom_BP8.pdf", bbox_inches='tight', bbox_extra_artists=[],pad_inches=0.03)
