...
for filename, outfile, coltype, vmin, vmax, dataset, freq, unit, scale, comp, labelpos, labels, bar in [
    #(directory+"BP_v2.00_full_cmb_mean_n512.fits", "bp_cmb_mean_T.pdf", 0, -3400, 3400., r"", r"$\left<T\right>$", r"$\mu\mathrm{K}$", 1, 0, [-3400,0,3400], [r"$-3400$", r"$0$", r"3400"], 1),        
    #(directory+"BP_v2.00_full_cmb_stddev_n512.fits", "bp_cmb_stddev_T.pdf", 0, 0., 50., r"", r"$\left<\sigma_T\right>$", r"$\mu\mathrm{K}$", 1, 0, [0,50], [r"$0$", r"50"], 1),

    #(directory+"BP_v2.00_full_cmb_mean_5deg.fits", "bp_cmb_mean_Q_5deg.pdf", 0, -2., 2., r"", r"$\left<Q\right>$", r"$\mathrm{\mu K}$", 1, 1, [-2,0,2], [r"$-2$", r"0", r"$2$"], 1),
    #(directory+"BP_v2.00_full_cmb_stddev_5deg.fits", "bp_cmb_stddev_Q.pdf", 0, 0., 2., r"", r"$\left<\sigma_Q\right>$", r"$\mu\mathrm{K}$", 1, 1, [0,2], [r"$0$", r"2"], 1),



    #(directory+"BP_v2.00_full_cmb_mean_5deg.fits", "bp_cmb_mean_U_5deg.pdf", 0, -2., 2., r"", r"$\left<U\right>$", r"$\mathrm{\mu K}$", 1, 2, [-2,0,2], [r"$-2$", r"0", r"$2$"], 1),        
#    (directory+"BP_v2.00_full_cmb_stddev_5deg.fits", "bp_cmb_stddev_U.pdf", 0, 0., 2., r"", r"$\left<\sigma_U\right>$", r"$\mu\mathrm{K}$", 1, 2, [0,2], [r"$0$", r"2"], 1),

    #(directory+"diff_cmb_map_n512_1deg.fits", "bp_cmb_sampdiff_T.pdf", 0, -20., 20., r"", r"$T^{(1)}-T^{(2)}$", r"$\mathrm{K}$", 1, 0, [-20,0,20], [r"$-20$", r"0", r"$20$"], 1),
    #(directory+"diff_cmb_map_5deg.fits", "bp_cmb_sampdiff_Q.pdf", 0, -2., 2., r"", r"$Q^{(1)}-Q^{(2)}$", r"$\mathrm{\mu K}$", 1, 1, [-2,0,2], [r"$-2$", r"0", r"$2$"], 1),
    #(directory+"diff_cmb_map_5deg.fits", "bp_cmb_sampdiff_U.pdf", 0, -2., 2., r"", r"$U^{(1)}-U^{(2)}$", r"$\mathrm{\mu K}$", 1, 2, [-2,0,2], [r"$-2$", r"0", r"$2$"], 1),

    (directory+"cmb_sn_5deg.fits", "bp_cmb_sn_Q.pdf", 0, -3., 3., r"", r"$\left<Q\right>/\sigma_Q$", r"$\sigma$", 1, 1, [-3,0,3], [r"$-3$", r"0", r"$3$"], 0),
    (directory+"cmb_sn_5deg.fits", "bp_cmb_sn_U.pdf", 0, -3., 3., r"", r"$\left<Q\right>/\sigma_Q$", r"$\sigma$", 1, 2, [-3,0,3], [r"$-3$", r"0", r"$3$"], 1),        
