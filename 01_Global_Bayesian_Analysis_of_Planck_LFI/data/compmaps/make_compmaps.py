...
for filename, outfile, coltype, vmin, vmax, dataset, freq, unit, scale, comp, labelpos, labels, bar in [
    #(directory+"BP_v1.00_hm1_synch_mean.fits", "bp_synch_mean_T.pdf", 0, 0., 100., r"", r"$\left<T\right>$", r"$\mathrm{K}$ at 408\,MHz", 1e-6, 0, [0,100], [r"$0$", r"$100$"], 1),
    (directory+"BP_v1.00_hm1_synch_stddev.fits", "bp_synch_stddev_T.pdf", 0, 0., 1., r"", r"$\left<\sigma_T\right>$", r"$\mathrm{K}$ at 408\,MHz", 1e-6, 0, [0,1], [r"$0$", r"1"], 1),

    #(directory+"BP_v1.00_hm1_synch_mean_1deg.fits", "bp_synch_mean_Q_1deg.pdf", 0, -30., 30., r"", r"$\left<Q\right>$", r"$\mathrm{\mu K}$ at 30\,GHz", 1, 1, [-30,0,30], [r"$-30$", r"0", r"$30$"], 1),
    (directory+"BP_v1.00_hm1_synch_stddev.fits", "bp_synch_stddev_Q.pdf", 0, 0., 10., r"", r"$\left<\sigma_{Q}\right>$", r"$\mathrm{\mu K}$ at 30\,GHz", 1, 1, [0,10], [r"$0$", r"10"], 1),


    #(directory+"BP_v1.00_hm1_synch_mean_1deg.fits", "bp_synch_mean_U_1deg.pdf", 0, -30., 30., r"", r"$\left<U\right>$", r"$\mathrm{\mu K}$ at 30\,GHz", 1, 2, [-30,0,30], [r"$-30$", r"0", r"$30$"], 1),        
    #(directory+"BP_v1.00_hm1_synch_stddev.fits", "bp_synch_stddev_U.pdf", 0, 0., 10., r"", r"$\left<\sigma_{U}\right>$", r"$\mathrm{\mu K}$ at 30\,GHz", 1, 2, [0,10], [r"$0$", r"10"], 1),


    #(directory+"diff_synch_map_3deg.fits", "bp_synch_sampdiff_T.pdf", 0, -1., 1., r"", r"$T^{(1)}-T^{(2)}$", r"$\mathrm{K}$ at 408\,MHz", 1e-6, 0, [-1,0,1], [r"$-1$", r"0", r"$1$"], 1),
    #(directory+"diff_synch_map_3deg.fits", "bp_synch_sampdiff_Q.pdf", 0, -5., 5., r"", r"$Q^{(1)}-Q^{(2)}$", r"$\mathrm{\mu K}$ at 30\,GHz", 1, 1, [-5,0,5], [r"$-5$", r"0", r"$5$"], 1),
    #(directory+"diff_synch_map_3deg.fits", "bp_synch_sampdiff_U.pdf", 0, -5., 5., r"", r"$U^{(1)}-U^{(2)}$", r"$\mathrm{\mu K}$ at 30\,GHz", 1, 2, [-5,0,5], [r"$-5$", r"0", r"$5$"], 1),
