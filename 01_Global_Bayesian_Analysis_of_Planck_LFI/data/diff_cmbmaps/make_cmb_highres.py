...
for filename, outfile, coltype, vmin, vmax, dataset, freq, unit, scale, comp, labelpos, labels, bar in [
    (directory+"npipe_v1_commander_cmb_40a_0256.fits", "cmb_npipe_pol_Q_n256_v1.pdf", 0, -3., 3., r"", r"$Q$", r"$\mathrm{\mu K}$", 1, 1, [-3,0,3], [r"$-3$", r"0", r"$3$"], 0),
    (directory+"npipe_v1_commander_cmb_40a_0256.fits", "cmb_npipe_pol_U_n256_v1.pdf", 0, -3., 3., r"", r"$U$", r"$\mathrm{\mu K}$", 1, 2, [-3,0,3], [r"$-3$", r"0", r"$3$"], 1),        
    ]:
