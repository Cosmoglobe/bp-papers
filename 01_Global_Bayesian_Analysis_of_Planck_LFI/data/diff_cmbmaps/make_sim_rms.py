...
for filename, outfile, coltype, vmin, vmax, dataset, freq, unit, scale, comp, labelpos, labels, bar in [
    (directory+"npipe6v20_sim_2deg_stddev.fits", "npipe6v20_sim_rms_2deg_Q_v1.pdf", 0, 0.2, 0.6, r"", r"$Q$", r"$\mathrm{\mu K}$", 1, 1, [0.2,0.6], [r"$0.2$", r"0.6"], 0),
    (directory+"npipe6v20_sim_2deg_stddev.fits", "npipe6v20_sim_rms_2deg_U_v1.pdf", 0, 0.2, 0.6, r"", r"$U$", r"$\mathrm{\mu K}$", 1, 2, [0.2,0.6], [r"$0.2$", r"0.6"], 1),
    ]:
