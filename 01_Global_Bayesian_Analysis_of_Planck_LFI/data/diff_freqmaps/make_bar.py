...
for width in [12.]:
    ...
    colorbar_ticks = np.array([-2, -1, 0, 1, 2])
    colorbar_boundaries = [-30000,30000] #np.concatenate([-1 * np.logspace(0, 3, 80)[::-1], np.linspace(-1, 1, 10), np.logspace(0, 7, 150)])
    ...
    output_filename = "colorbar_2uK.pdf"
