...
%\input{Planck} % Planck style file
%=======================================================================================
...
%
% version 29 Jan 2022       --- added all necessary additional parameters, macros and units for this paper (BP XIII)
% author: K. J. Andersen
%
...
\title{\bfseries{\scshape{BeyondPlanck}} XIII. Intensity foreground
  sampling,\\ degeneracies, and priors}

%\input{BP_XIII_authors.tex}
%=================================================
%BeyondPlanck author file for BeyondPlanck XIII: Intensity foreground sampling, degeneracies and priors
%--------------------------------------------------
%This author list corresponds to \title{Author list for BP\_XIII\_Intensity\_foreground\_sampling\_degenracies\_and\_priors}
%Initially prepared by M. Lopez-Caniego (Marcos.Lopez.Caniego@sciops.esa.int), ESAC/ESA
%on Thu Jul 12 18:11:48 2018 CET
%Last edited by K. J. Andersen on Sun Sep 4 15:15 2022 CEST
\newcommand{\oslo}[0]{1}
...
\author{\small
K.~J.~Andersen\inst{\oslo}\thanks{Corresponding author: K.~J.~Andersen; \url{k.j.andersen@astro.uio.no}, \url{andersen.kristian.joten@gmail.com}}
\and
D.~Herman\inst{\oslo}
\and
...
\abstract{We present the intensity foreground algorithms and model
  employed within the \BP\ analysis framework. The
    \BP\ analysis is aimed at integrating component separation and
    instrumental parameter sampling within a global framework, leading to
    complete end-to-end error propagation in the \Planck\ Low
    Frequency Instrument (LFI) data analysis.
    Given the scope of the \BP\ analysis, a limited set of
  ...
  through external priors. Future works will be aimed at integrating many
  more data sets into this analysis, both map and time-ordered based,
thereby gradually eliminating the currently observed
  degeneracies in a controlled manner with respect to both
  instrumental systematic effects and astrophysical degeneracies. When
...
\tablefoot{\\
 ...
 \tablefoottext{b}{The native resolution of 857\,GHz is 4.64\arcmin\ FWHM
   \citep{planck2014-a08}, smoothed to 10\arcmin\ FWHM in this analysis. }\\
 ...
 \tablefoottext{d}{The native resolution of 408\,MHz is 56\arcmin\ FWHM
   \citep{haslam1982}, smoothed to 60\arcmin\ FWHM in this analysis. }\\
...
steps, we refer to \citet{bp01} and references therein.
...
The results of the 300 samples for the full sky spectral parameters and band monopoles can be seen in Figs.~\ref{fig:simulated_indices} and \ref{fig:simulated_monopoles} respectively. Much like the sky component maps, we see excellent agreement with the input values for both spectral parameters and the band monopoles. We note that both the spectral indices and the band monopoles show a few samples which are significant deviations from the input value. This is to be expected, and is in fact an intention of the algorithms implemented in this work. As described in Sec.~\ref{subsec:monopole_index}, the marginalization over the band monopoles allows for a broader log-likelihood, corresponding to a more complete exploration of the underlying distribution.
\begin{figure*}
\centering
\includegraphics[width=0.3\linewidth]{figs/epsilon_ame_wspec.pdf}
\includegraphics[width=0.3\linewidth]{figs/epsilon_cmb_wspec.pdf}
\includegraphics[width=0.3\linewidth]{figs/epsilon_dust_wspec.pdf}\\
\includegraphics[width=0.3\linewidth]{figs/epsilon_ff_wspec.pdf}
\includegraphics[width=0.3\linewidth]{figs/epsilon_synch_wspec.pdf}
\caption{Relative difference maps, $\epsilon_i$, for each of the sky components within the simulated \BP\ dataset. Top row: AME, CMB, and thermal dust maps. Bottom row: Free-free and synchrotron maps.}
...
\begin{figure*}
  ...
  \includegraphics[width=0.32\linewidth]{figs/res_060-WMAP_V1_mean_f2g_120arcmin_T_w8_c-planck.pdf}
  \includegraphics[width=0.32\linewidth]{figs/res_060-WMAP_V2_mean_f2g_120arcmin_T_w8_c-planck.pdf}\\
  \includegraphics[width=0.7\linewidth]{figs/colorbar_range5_w18_uKcmb_c-planck.pdf}\vspace{0.3cm}\\
  \includegraphics[width=0.33\linewidth]{figs/res_Haslam_mean_f2g_120arcmin_T_w8_cb_c-planck.pdf}
  \includegraphics[width=0.33\linewidth]{figs/res_857_mean_f2g_120arcmin_T_w8_cb_c-planck.pdf}
  \includegraphics[width=0.33\linewidth]{figs/chisq_reduced_mean_T_w8_n16_cb_c-coolwarm.pdf}  
...
\caption{Comparison of frequency channel monopole constraints from
  ...
  857\,GHz, which is taken from \Planck\ DR4 \citep{npipe}. We note that
  ...
  has no associated uncertainty. Lastly, we note that while the \WMAP\ and
...
\begin{figure*}
  \center       
  \includegraphics[width=0.32\linewidth]{figs/radio_030_mean_gnomonic_90lon70lat_20x20deg_cmap-ember_nobar_logscale.pdf}
  \includegraphics[width=0.32\linewidth]{figs/radio_044_mean_gnomonic_90lon70lat_20x20deg_cmap-ember_nobar_logscale.pdf}
  \includegraphics[width=0.32\linewidth]{figs/radio_070_mean_gnomonic_90lon70lat_20x20deg_cmap-ember_nobar_logscale.pdf}\\
  \includegraphics[width=0.7\linewidth]{figs/colorbar_0_to_100_log_w18_uKcmb_c-ember.pdf}\vspace{0.3cm}\\
  \includegraphics[width=0.32\linewidth]{figs/radio_030_stddev_gnomonic_90lon70lat_20x20deg_cmap-neutral_nobar_logscale.pdf}
