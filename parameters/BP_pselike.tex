...
\title{\textit{BeyondPlanck} results. VI. Power Spectra, Likelihoods and Cosmological Parameters}
...
\section{Low Resolution dataset}
\label{sec:dataset}

\section{PSE and Likelihood}
\label{sec:pselike}

\section{Cosmological parameters from BP+Planck}
\label{sec:params}

\section{Constraints on reionization}
\label{sec:reio}
